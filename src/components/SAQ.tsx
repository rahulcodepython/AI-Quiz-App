...
const SAQ = ({ question, handleChangeAnswer }: { question: Question, handleChangeAnswer: (questionId: string, answer: string) => void }) => {
    return (
        <div className={`bg-purple-50 dark:bg-gray-900 p-6 rounded-lg border-l-4 border-purple-500 flex flex-col gap-4`}>
